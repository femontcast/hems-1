...
st.write("Por favor cargue en este espacio un archivo CSV con los datos de Temperatura y Velocidad del aire. El archivo debe contener las siguientes columnas: Temperatura seca, Temperatura de bulbo humedo, Temperatura de globo, Velocidad del aire y Humedad relativa")
#Datos default
temp_aire=  32.00
temp_globo= 36.00
temp_bulbo= 28.00
velocidad_aire= 0.016
#Carga del csv
...
if archivo is not None:
    ...
    try:
        humedad_relativa= datos_ambientales["Humedad relativa"].mean()
    except: 
        st.warning("No se encontró la columna 'Humedad relativa' en el archivo. Asegúrate de que el archivo contenga esta columna.")
    try:
        presion_aire= datos_ambientales["Presion del aire"].mean()
    except:
        st.warning("No se encontró la columna 'Presion del aire' en el archivo. Asegúrate de que el archivo contenga esta columna.")
    # Mostrar los datos de temperatura y velocidad del aire
    st.write("Los datos de temperatura y velocidad del aire han sido cargados correctamente, porfavor verifique que los datos sean correctos")
